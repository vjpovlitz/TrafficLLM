...
CAMERA_NAME = "US_50_AT_EX23_MD2"
CAMERA_URL = "https://mdta.maryland.gov/index.php/traffic-cameras-by-facility#camera-48"
...
def capture_screenshot():
    ...
    # Build a standardized file name, e.g. 20250101_130000_US_50_AT_EX23_MD2.png
    timestamp_str = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
    filename = f"{timestamp_str}_{CAMERA_NAME}.png"
